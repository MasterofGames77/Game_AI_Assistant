...
//     const storedData = await NintendoData.findOne({ source: 'nintendoNewsUS' })
...
//       if (dataAge < maxAge) {
//         console.log(`[Nintendo News] Returning cached data from MongoDB (${storedData.data.length} records, ${Math.floor(dataAge / (60 * 60 * 1000))}h old)`);
...
//         });
//       } else {
//         console.log(`[Nintendo News] MongoDB data is too old (${Math.floor(dataAge / (60 * 60 * 1000))}h), falling back to Bright Data`);
//       }
//     } else {
//       console.log('[Nintendo News] No data in MongoDB, falling back to Bright Data');
//     }
...
//     console.log('[Nintendo News] Fetching from Bright Data (fallback)...');
//     const data = await runCollector({
//       collectorKey: 'nintendoNewsUS',
//       input: {}, // Use default input
//       cacheKey: 'nintendoNewsUS:fallback',
//       cacheTtlSeconds: 60 * 10, // 10 minutes cache for fallback
